...
const siteMetadata = {
  ...
  siteUrl: 'https://boilershaus.vercel.app',
  siteRepo: 'https://github.com/boilerrat/boilerhaus',
  siteLogo: `${process.env.BASE_PATH || ''}/static/images/boilershaus.png`,
  socialBanner: `${process.env.BASE_PATH || ''}/static/images/twitter-card.png`,
  Farcast: 'https://warpcast.com/boiler',
  email: '128boilerrat@gmail.com',
  github: 'https://github.com/boilerrat',
  x: 'https://twitter.com/boilerrat',
  // twitter: 'https://twitter.com/Twitter',
  // facebook: 'https://facebook.com',
  youtube: 'https://youtube.com/@boilerrat',
